...
void TextureSamplerDemo::Initialize()
{
	...
	shader = new Shader(L"12_TextureSampler.fx");
	...
	texture2 = new Texture(L"Floor.png");
}
...
void TextureSamplerDemo::Update()
{
	...
	//{
	//	function<void(wstring)> f = bind(&TextureSamplerDemo::LoadTexture, this, placeholders::_1); //placeholders:인자 갯수
...
//void TextureSamplerDemo::LoadTexture(wstring file)
//{
...
void TextureSamplerDemo::CreateVertex()
{
	//      1     3       
	//      
	//      0     2
...
void TextureSamplerDemo::CreateVertexEnemy(ID3D11Buffer** vertexBuffer)
{
	//Local
...
bool TextureSamplerDemo::CheckRectCollision(Matrix player, Matrix enemy)
{
	return IsIntersect(player._41 - 0.5f, player._42 - 0.5f, 0.5f, 0.5f, enemy._41 - 0.5f, enemy._42-0.5f, 0.5f, 0.5f);
	return false;
}
bool TextureSamplerDemo::IsIntersect(int x1, int y1, int w1, int h1, int x2, int y2, int w2, int h2)
{ 
