...
#include "../Framework/MoveCamera.h"
...
void GetHeightDemo::Update()
{
	...
	//{
	//	function<void(wstring)> f = bind(&GetHeightDemo::LoadTexture, this, placeholders::_1); //placeholders:인자 갯수
...
//void GetHeightDemo::LoadTexture(wstring file)
//{
...
void GetHeightDemo::CreateVertex()
{
	////      1     3       
	////      
	////      0     2
...
void GetHeightDemo::CreateVertexEnemy(ID3D11Buffer** vertexBuffer)
{
	////Local
...
bool GetHeightDemo::CheckRectCollision(Matrix player, Matrix enemy)
{
	return IsIntersect(player._41 - 0.5f, player._42 - 0.5f, 0.5f, 0.5f, enemy._41 - 0.5f, enemy._42-0.5f, 0.5f, 0.5f);
	return false;
}
bool GetHeightDemo::IsIntersect(int x1, int y1, int w1, int h1, int x2, int y2, int w2, int h2)
{ 
